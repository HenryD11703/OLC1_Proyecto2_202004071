...
class Logica extends Instruccion_1.Instruccion {
    ...
    */
    buildAst(anterior) {
        var _a, _b, _c;
        let tipoOperacion = "";
        if (this.Operador === OperadorLogico.IGUALIGUAL)
            tipoOperacion = "==";
        if (this.Operador === OperadorLogico.DIFERENTE)
            tipoOperacion = "!=";
        if (this.Operador === OperadorLogico.MENOR)
            tipoOperacion = "<";
        if (this.Operador === OperadorLogico.MENORIGUAL)
            tipoOperacion = "<=";
        if (this.Operador === OperadorLogico.MAYOR)
            tipoOperacion = ">";
        if (this.Operador === OperadorLogico.MAYORIGUAL)
            tipoOperacion = ">=";
